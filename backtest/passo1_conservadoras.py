"""Passo 1: Testar configurações conservadoras em 5 anos (2021-2025)."""
import sys
...
def main():
    ...
    configs = [
        Config("WIN_ML2_SL200_100_50", "WIN", 25, 5.0, 0.20, 100.0, 50.0, 2, 200.0, False, years),
        Config("WIN_ML2_SL250_100_50", "WIN", 25, 5.0, 0.20, 100.0, 50.0, 2, 250.0, False, years),
        Config("WIN_ML2_SL200_150_75", "WIN", 25, 5.0, 0.20, 150.0, 75.0, 2, 200.0, False, years),
        Config("WIN_ML3_SL200_100_50", "WIN", 25, 5.0, 0.20, 100.0, 50.0, 3, 200.0, False, years),
        Config("WIN_ML2_SL200_100_50_mart", "WIN", 25, 5.0, 0.20, 100.0, 50.0, 2, 200.0, True, years),
        Config("WIN_ML3_SL250_100_50", "WIN", 25, 5.0, 0.20, 100.0, 50.0, 3, 250.0, False, years),
        Config("WIN_ML2_SL150_100_50", "WIN", 25, 5.0, 0.20, 100.0, 50.0, 2, 150.0, False, years),
    ]

    all_results = []
    for cfg in configs:
        print(f">>> Passo 1 | Testing {cfg.name}...", flush=True)
        res = run_config(cfg)
    ...
    out_path = PROJECT_ROOT / "reports" / "passo1_conservadoras_2021_2025.json"
